...
export const Navbar: FC<TProps> = ({ openSidebar, setOpenSidebar }) => (
  <div className="flex h-fit bg-gray-900/70 text-gray-100 w-full justify-end sm:justify-between items-center ps-2.5 pe-5 lg:ps-5 lg:pe-10 py-3 border-b border-b-neutral-400/35">
