...
export const Card: FC<CardProps> = (props) => {
  ...
  //   setBgConic(
  //     percentageLeft > 65
  //       ? "text-success-500/50 bg-success-700/10"
  //       : percentageLeft > 30
  //       ? "text-pending-500/50 bg-pending-700/10"
  //       : "text-error-500/50 bg-error-700/10"
  //   );
  ...
  return (
    <div className="bg-black/30 border border-link-700/30 flex items-center justify-center rounded-lg max-w-[400px] w-full">
      <div
        className={cn(
      ...
      >
        <div className="max-w-[500px] rounded-lg w-full">
          ...
          <div className="relative bg-neutral-text-title/20 backdrop-blur-lg  rounded-lg p-5 space-y-2 cursor-pointer duration-200 z-20">
            <h1
              title={taskName}
