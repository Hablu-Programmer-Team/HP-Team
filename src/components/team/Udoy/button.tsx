...
export const Button: FC<IProps> = ({
  ...
  disabled,
  onClick,
  //   you can pass hover effect also, if you don't pass hover props then it will be default style
  ...
  // ......................
  // =====------------=========
  //   you will be able to cahange hover style by passing prpos like hover="hover:text-bg-green" or you can use hover="auto" for getting deafult coustom hover;
  ...
  //   you will be able to cahange rouned style by passing prpos like round="sm" or "md" or you can use there coustom class;
  //   if does not pass hover props. it will take rounded-full
  const roundedStyle =
    round === "sm" ? "rounded-sm" : round === "md" ? "rounded-md" : round;
  // if you want to use icon between the button then you will be able to use flex for giving flex vibe
  const flexStyle = "flex items-center justify-center text-nowrap gap-1";
  //  you will be able to change also text color. if you don't pass colors props then by default it will balck color. also you can pass taiwlindcss color style like text-green-500 something like.
  ...
  const btnClasses =
    ...
    className ||
    // if you do not pass className that means you want to use my coustom style.  to do that you can pass props to style the button without writing long classname
    generateClassNames(
      fontBoldStyle,
      textColor,
